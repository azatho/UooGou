	...
	<view>
			...
			<block v-for="(items,k) in goods_list" :key="k">
				<view class="two" @click="goDetail(items.goods_index,items.goods_id,items.is_ok,items.jump_type)"
					...
					<view class="details">
						...
						<view class="xia">
							...
							<view class="btn2"
								@click="afterSale(items,orderInfo.barter_button,orderInfo.refund_button,orderInfo.ps_phone,orderInfo.frequent_phone)">
								申请售后</view>
						</view>
					</view>
				</view>
				<view class="two" @click="goDetail(items.goods_index,items.goods_id,items.is_ok,items.jump_type)"
					...
					<view class="details">
						...
						<view class="xia">
							<view class="univalence" v-if='goods_list[k].goods_type==0'>
								￥{{items.goods_cost/100?items.goods_cost/100:'0'}}</view>
							<view class="univalence" v-else>
								￥{{items.goods_integral==0?items.goods_cost/100:items.goods_cost/100+'+'+items.goods_integral/100+'积分'}}
							</view>
		...
		<view class="price">
			<view class="goodprice">
				...
				<view class="two">
					￥{{orderInfo.order_score_price!=0?orderInfo.order_goods_price/100+'+'+orderInfo.order_score_price/100+'积分':orderInfo.order_goods_price/100}}
				</view>
			</view>
			<view class="goodprice">
			...
			afterSale(e, barter_button, refund_button, ps_phone, frequent_phone) {
				uni.navigateTo({
					url: '../common/afterSale?goods_index=' + e.order_goods_index + '&barter_button=' +
						...
						ps_phone + '&frequent_phone=' + frequent_phone
				})
