...
<template>
	<view v-if="displys">
		...
		<view class="flexd">
			...
			<view class="center" v-if="rank==1">商户入驻</view>
			<view class="center" v-if="rank==2">审核进度</view>
			<view></view>
			<view class="center" v-if="rank==3">商家管理中心</view>
		</view>
		<view class="bgcImg" v-if="rank==1">
			<view class="bgc2">
				<image src="../../static/enter2.png"></image>
			</view>
			<view class="bgc3">
				<view class="bgc4">
			...
			<view class="bgc5">
				<view class="bgc4">
					<view class="yuan"></view>社区店开店须知<view class="yuan"></view>
				</view>
				<view class="text">
		...
		<view class="audit" v-if="rank==2">
			...
			<view v-if="applyInfo.apply_status==1||applyInfo.apply_status==3">
				<!-- steps步骤条  纵向排列-->
				<uni-steps :options="options" direction="column" :active="0" v-if="applyInfo.apply_status==1">
				</uni-steps>
		...
		<view class="adminsistration" v-if="rank==3">
			<view class="shopadmin">
				...
				<view class="pressbutt">
					<view v-if="business==true&&SupplierCenter.is_open==1" @click="getbusiness(SupplierCenter.is_open)"
						class="one">
						<image src="../../static/wxz.png"></image>
						<text>营业中</text>
					</view>
			...
			<view class="money">
				<view class="left" @click="getwithdraw">
					<view>
						<view>可提现余额(元)</view>
						<view class="one">{{$returnFloat(SupplierCenter.cash)}}</view>
					</view>
					<view>
						<image src="../../static/jts.png" mode="" style="width: 14rpx;height: 26rpx;"></image>
					</view>
				</view>
				<view style="width: 2px; height: 110rpx;background-color: #FFFFFF;opacity: 0.2;"></view>
				<view class="left" @click="getaccount">
					<view>
						<view>销售积分</view>
						<view class="one">{{$returnFloat(SupplierCenter.supplier_score)}}</view>
					</view>
					<view>
						<image src="../../static/jts.png" mode="" style="width: 14rpx;height: 26rpx;"></image>
					</view>
			...
			<view class="statistics">
				...
				<view class="xia">
					<view class="oen" style='margin-top:10rpx'>
						<view class="num">{{$returnFloat(SupplierCenter.today_money)}}</view>
						<view>今日营收</view>
					</view>
					<view class="oen" style='margin-top:10rpx'>
						<view class="num">{{$returnFloat(SupplierCenter.month_money)}}</view>
						<view>本月营收</view>
					</view>
					<view class="oen" style='margin-top:10rpx'>
						<view class="num">{{$returnFloat(SupplierCenter.all_money)}}</view>
						<view>累计营收</view>
					</view>
				</view>
			</view>
				...
				<view class="xia" style="margin-top: 70rpx;">
					<view class="right">
						...
						<view class="oen">
							...
							<view
								style="font-size: 22rpx;font-family: Source Han Sans CN;font-weight: 400;color:#666666">
								全部订单</view>
						</view>
						<view class="oen">
			...
			<view class="management">
				...
				<view class="" style="display: flex;margin-top: 30rpx;">
					<view class="" @click="addprouct"
						style="display: flex;align-items: center;flex-direction: column;width: 25%;">
						<image src="../../static/gl1.png" mode="" style="width: 44rpx;height: 44rpx;"></image>
						<p style="margin: 20rpx 0;">添加商品</p>
					</view>
					<view class="" style="display: flex;align-items: center;flex-direction: column;width: 25%;"
						@click="goodsGl">
						<image src="../../static/gl2.png" mode="" style="width: 44rpx;height: 44rpx;"></image>
						<p style="margin: 20rpx 0;">商品管理</p>
					</view>
					<view class="" @click="jinhuojilu"
						style="display: flex;align-items: center;flex-direction: column;width: 25%;">
						<image src="../../static/gl3.png" mode="" style="width: 44rpx;height: 44rpx;"></image>
						<p style="margin: 20rpx 0;">进货记录</p>
					</view>
					<view class="" @click="jinhuo"
						style="display: flex;align-items: center;flex-direction: column;width: 25%;">
						<image src="../../static/gl4.png" mode="" style="width: 44rpx;height: 44rpx;"></image>
						<p style="margin: 20rpx 0;">进货</p>
					</view>
				</view>
			</view>
			<view class="footer">
				...
				<view class="right">
					...
					<view style="word-break:break-all">网址: {{wangzhi1}}
						<image src="../../static/enter6.png" class="img1" @click="fzs(wangzhi1)"></image>
					</view>
				</view>
			</view>
		</view>
		<!-- 添加商品弹窗 -->
		<view class="beijing" v-if="isAddGoods" @click.stop="isAddGoods=false">
			<view class="content">
				<view style="background: #FFFFFF;border-radius: 10rpx;">
					<view class=""
						style="padding:20rpx 0;text-align: center;color: #999999;font-weight: 400;font-family: PingFang SC;font-size: 26rpx;">
						请选择添加商品的方式：</view>
					<view class="" @click="zizhuadd"
						style="padding:20rpx 0;text-align: center;color: #333333;font-weight: 400;font-family: PingFang SC;font-size: 26rpx;border-top:1px solid #f5f5f5;border-bottom:1px solid #f5f5f5;">
						自主添加</view>
					<view class="" @click="shareAdd"
						style="padding:20rpx 0;text-align: center;color: #333333;font-weight: 400;font-family: PingFang SC;font-size: 26rpx;">
						共享产品库添加</view>
				</view>
				<view class="cancel" @click="cancel"
					style="border-radius: 10rpx;background: #FFFFFF;padding: 20rpx 0;text-align: center;margin: 20rpx 0;">
					取消
				</view>
			</view>
		</view>
