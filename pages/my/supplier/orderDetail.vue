...
<template>
	<view>
		...
		<view class="site">
			<view class="img">
				<image src="../../../static/ddicon.png"></image>
				<view class="center">
					...
					<view class="dizhi">{{orderInfo.order_address}}					<image src="../../../static/maoAdress.png" mode="" style="width:46rpx;height:46rpx;vertical-align:middle;margin:0 10rpx;" @click="getmap(orderInfo.lng,orderInfo.lat,orderInfo.order_address)"></image></view>
				</view>
			</view>
			<view class="right">
	...
	<!-- 	<view class="time" v-if="orderInfo.order_status!=0">
		...
		<view class="price">
			<view class="goodprice">
				...
				<view class="two">￥{{orderInfo.order_goods_price?orderInfo.order_goods_price/100:'0'}}</view>
			</view>
			<view class="goodprice">
			...
			<view class="goodprice">
				...
				<view class="two1">{{orderInfo.order_total_price!=0?'￥'+orderInfo.order_total_price/100:'0'}}</view>
			</view>
		</view>
		<view style="width: 100%; height: 20rpx; background-color: #F5F5F5;"></view>
		<!-- 配送员信息-->
		<div class="order1" v-if="orderInfo.order_status>2 && orderInfo.order_status<7&&orderInfo.express_num==0" style="margin-bottom: 10rpx!important;">
		...
		<!-- 按钮 -->
		<view class="btn">
			<view class="btn1" @click="ljfh(orderInfo.order_index)" v-if="orderInfo.order_status==2">
				立即发货
			</view>
			<view class="btn3" v-if="orderInfo.order_status==5">
				待收货
			</view>
			<view class="btn3" v-if="orderInfo.order_status==6">
				已完成
			</view>
			<view class="btn3" v-if="orderInfo.order_status==0">
				已取消
			</view>
			<view class="btn3" @click="shenhe" v-if="orderInfo.order_status==7">
				审核
			</view>
			<view class="btn3" v-if="orderInfo.order_status==9">
				退款成功
			</view>
		</view>
		<!-- 发货弹窗 -->
