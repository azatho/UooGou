...
<template>
	<view>
		...
		<view class="flexd">
			...
			<view class="center" v-if="reveal == 1">公司资料</view>
			<view class="center" v-else>资质信息</view>
			<view></view>
		</view>
		<view class="bgc" v-if="reveal == 1">
			<view class="proposer">
				...
				<view class="radio">
					<view class="area">公司名称</view>
					<input type="text" placeholder="请输入公司名称" :value="shopaddress" @input="goshop" />
				</view>
				<view class="radio">
				...
				<view class="hang">
					...
					<view class=""  v-else>
						<image :src="cdnUrl + imgs2" @click="addImg2()"></image>
						<image @click="delGoods_video"  src="../../../static/caca.png" mode=""
					</view>
				</view>
		...
		<view class="bgc" v-if="reveal == 2">
			...
			<view class="time" style="margin-bottom: 20rpx;">
				...
				<view class="lang" @click="golang()">
					...
					<image src="../../../static/chooseOrange.png" v-else></image>
					长期有效
				</view>
			...
			<view class="xieyi" style="display: flex; margin-left: 200rpx;">
				<view @click="goagree">
					<image src="../../../static/chooseOrange.png" v-if="agree == true"></image>
					<image src="../.././../static/fk_icon.png" v-else></image>
					<text>我已阅读并同意</text>
				</view>
				<text style="color:#FF862B;" @click="getagreement">《供应商入驻协议》</text>
			</view>
