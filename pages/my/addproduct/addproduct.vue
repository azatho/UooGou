	...
	<view style="background:#F5F5F5;padding: 10rpx 0rpx;font-size: 26rpx;color: #999999;font-family: PingFang SC;font-weight: 400;">
		...
		<view class="" style="margin-top:20rpx;background: #fff;display: flex;justify-content: space-between;align-items: center;padding: 10rpx 30rpx;">
		   ...
		   <view class="" style="width: 120rpx;height: 120rpx;position: relative;">
			  ...
			  <image @click="delGoods_icon" v-if="formData.goods_icon" src="../../../static/caca.png" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
		   </view>
		</view>
		<!-- 上传视频  -->
		<view class="" style="margin-top:20rpx;background: #fff;display: flex;justify-content: space-between;align-items: center;padding: 10rpx 30rpx;">
		   ...
		   <view class="" style="width: 120rpx;height: 120rpx;position: relative;">
			  ...
			  <image @click="delGoods_video" v-if="formData.goods_video" src="../../../static/caca.png" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
		   </view>
		</view>
		<!-- 视频封面 -->
		<view class="" style="background: #fff;display: flex;justify-content: space-between;align-items: center;padding: 10rpx 30rpx;">
		   ...
		   <view class="" style="width: 120rpx;height: 120rpx;position: relative;">
		   	  <image @click="upVideoImg"  :src="!formData.goods_video_cover?uploadImg:$cdnUrl + formData.goods_video_cover" style="width: 120rpx;height: 120rpx;" mode="aspectFill"></image>
			  <image @click="delGoods_VideoImg" v-if="formData.goods_video_cover" src="../../../static/caca.png" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
		   </view>
		</view>
		<!-- 商品相册 -->
		<view class="" style='background: #fff;padding: 15rpx 30rpx;margin-top: 10rpx;'>
		  ...
		  <view class="" style="display: flex;flex-wrap: wrap;margin-top: 20rpx;">
			  <view class="" v-for="(item,index) in goods_img" style="margin-right:15rpx;width: 120rpx;height: 120rpx;position: relative;">
				...
				<image @click="delGoodsList(index)" src="../../../static/caca.png" v-if="item" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
			  </view>
		  	  <view class="" v-if="goods_img.length < 5">
		  	  	<image @click="upGoodsImgList"  :src="uploadImg" style="width: 120rpx;height: 120rpx;" mode="aspectFill"></image>
		  	  </view>
		  </view>
		</view>
		<!-- 金额设置 -->
		...
		<view class="goodsTop">
		  ...
		  <h2 style="display: flex;align-items: center;font-size: 26rpx;font-weight: bold;color:#333;font-family: PingFang SC;padding: 15rpx 0;">金额设置<text  style="color: #999999;">(至少填写一种，积分最少设置为100）</text></h2>
		  ...
		  <!-- 属性图片 -->
		  <view class="" style="margin-top:20rpx;background: #fff;display: flex;justify-content: space-between;align-items: center;padding-bottom: 10rpx;">
		     <view class="">
		     ...
		     <view class="" style="width: 120rpx;height: 120rpx;position: relative;">
		     	  <image @click="upAttributeimg"  :src="!formData.sku_pic?uploadImg:$cdnUrl + formData.sku_pic" style="width: 120rpx;height: 120rpx;" mode="aspectFill"></image>
		  	      <image @click="delAttributeimg" v-if="formData.sku_pic" src="../../../static/caca.png" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
		     </view>
		  </view>
		</view>
		...
		<view class="" style='background: #fff;padding: 15rpx 30rpx;margin-top: 10rpx;'>
		  ...
		  <view class="" style="display: flex;flex-wrap: wrap;margin-top: 20rpx;">
			  <view class="" v-for="(item,index) in goods_desc" style="margin-right:15rpx;width: 120rpx;height: 120rpx;position: relative;">
			  	<image   :src="$cdnUrl + item" style="width: 120rpx;height: 120rpx;" mode="aspectFill"></image>
				<image @click="delGoodsDescList(index)" src="../../../static/caca.png" v-if="item" mode="" style="width:36rpx;height:36rpx;position: absolute;right: -14rpx;top:-14rpx;"></image>
			  </view>
		...
		<view @click="selectParams" style="display: flex;align-items: center;justify-content: space-between;padding: 20rpx 30rpx;background-color: #fff;">
			<view>
				<p style="color: #333333;font-weight: 400;font-family: PingFang SC;font-size: 26rpx;font-family: PingFang SC;">
				   商品参数(选填)
				</p>
				<p>
				  商品包装、尺寸、储存方式、保质期等
		...
		<view @click="addGoodsSub" style="width: 690rpx;height: 90rpx;
color: #FFFFFF;
font-weight: 500;
font-family: PingFang SC;
font-size: 30rpx;text-align: center;border-radius: 45rpx;background: #F5281C;line-height: 90rpx;margin: 60rpx auto;">
			提交
		</view>
	</view>
</template>
