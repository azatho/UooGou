...
<template>
	<view>
		<view class="nav">
			<view v-for="(item,index) in navList" @click="selectNav(index)" :class="index==navIndex?'navSelct':''">
				{{item}}
			</view>
		</view>
		<view v-if="dataList.data.length==0" class="noData" style="text-align: center;">
